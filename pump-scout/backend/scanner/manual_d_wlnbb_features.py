...
def compute_d_wlnbb_confluence(candles: list[dict]) -> dict:
    ...
    elif d11_beup_same:          type_v2 = "D11_BEUP"
    elif d9_beup_same:           type_v2 = "D9_BEUP"
    elif d1_l34_same:            type_v2 = "D1_L34"
    elif d11_l34_same:           type_v2 = "D11_L34"
    elif d9_l34_same:            type_v2 = "D9_L34"
    elif d1_l43_same:            type_v2 = "D1_L43"
    elif d11_l43_same:           type_v2 = "D11_L43"
    elif d9_l43_same:            type_v2 = "D9_L43"
    ...
    elif type_v2 == "D11_BEUP":              expl = "D11 + BE Up same bar"
    elif type_v2 == "D9_BEUP":               expl = "D9 + BE Up same bar"
    elif type_v2 == "D1_L34":               expl = "D1 + L34 same bar"
    elif type_v2 == "D11_L34":              expl = "D11 + L34 same bar"
    elif type_v2 == "D9_L34":               expl = "D9 + L34 same bar"
    elif type_v2 == "D1_L43":               expl = "D1 + L43 same bar"
    elif type_v2 == "D11_L43":              expl = "D11 + L43 same bar"
    elif type_v2 == "D9_L43":               expl = "D9 + L43 same bar"
    ...
    elif d11_beup_same:          d_confluence_type = "D11_BEUP"
    elif d9_beup_same:           d_confluence_type = "D9_BEUP"
    elif d1_l34_same:            d_confluence_type = "D1_L34"
    elif d11_l34_same:           d_confluence_type = "D11_L34"
    elif d9_l34_same:            d_confluence_type = "D9_L34"
    elif d1_l43_same:            d_confluence_type = "D1_L43"
    elif d11_l43_same:           d_confluence_type = "D11_L43"
    elif d9_l43_same:            d_confluence_type = "D9_L43"
    ...
    _cb_r   = max(candles[i]["high"] - candles[i]["low"], 1e-6)
    _cb_pos = (candles[i]["close"] - candles[i]["low"]) / _cb_r
    _cb_lwk = (min(candles[i]["open"], candles[i]["close"]) - candles[i]["low"]) / _cb_r
    ...
    if i > 0:
        ...
        _gap_up = candles[i]["open"] > _pb["close"] * 1.002
        _has_wc_gap_ld = bool(
            _pb_pos <= 0.35 and _gap_up
            and _cb_pos >= 0.50 and _cb_lwk >= 0.20
        )

    # L34 + lower-wick reclaim on same bar (scanner approximation of has_l34_np_ld;
    # NP engine state is not available here — l34 being active is the proxy).
    _has_l34_np_ld = bool(l34 and _cb_pos >= 0.50 and _cb_lwk >= 0.20)
    ...
    return {
        ...
        # ── Two-bar / same-bar demand ─────────────────────────────────────────
        "has_wc_gap_ld":  _has_wc_gap_ld,
        "has_l34_np_ld":  _has_l34_np_ld,
